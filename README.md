...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x2zja10.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x2zja10.containers.anotherwebservice.com/
...
```
git clone git@github.com:almira1981/container-x2zja10.git
cd container-x2zja10
```
...
```
docker attach container-x2zja10
```
